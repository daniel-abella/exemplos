...
public class Resources extends MIDlet implements CommandListener {
	...
	public Resources() {
		...
		addLine(frmDetails, "Screen: " + canTmp.getWidth() + "x"
				+ canTmp.getHeight() + "x" + disThis.numColors()
				+ (disThis.isColor() ? "" : "grays"));
		addLine(frmDetails, "Configuration: "
				+ readProperty("microedition.configuration"));
		addLine(frmDetails, "Profiles: "
				+ readProperty("microedition.profiles"));
		addLine(frmDetails, "Locale: " + readProperty("microedition.locale"));
		addLine(frmDetails, "Platform: "
				+ readProperty("microedition.platform"));
		addLine(frmDetails, "Total mem: " + Runtime.getRuntime().totalMemory());
		addLine(frmDetails, "Char encoding: "
				+ readProperty("microedition.encoding"));
		addLine(frmDetails, "Comm Ports: "
				+ readProperty("microedition.commports"));
		addLine(frmDetails, "Screen buffered: "
				+ (canTmp.isDoubleBuffered() ? "yes" : "no"));
		addLine(frmDetails, "Has pointer events: "
				+ (canTmp.hasPointerEvents() ? "yes" : "no"));
		addLine(frmDetails, "Has motion events: "
				+ (canTmp.hasPointerMotionEvents() ? "yes" : "no"));
		addLine(frmDetails, "Has key-held events: "
				+ (canTmp.hasRepeatEvents() ? "yes" : "no"));
		...
		addLine(frmDetails, "Nokia UI: "
				+ (isClass("com.nokia.mid.ui.DeviceControl") ? "yes" : "no"));
		addLine(frmDetails, "Nokia sound: "
				+ (isClass("com.nokia.mid.sound.Sound") ? "yes" : "no"));
		addLine(frmDetails, "JSR-82 bluetooth: "
				+ (isClass("javax.bluetooth.LocalDevice") ? "yes" : "no"));
		addLine(frmDetails, "JSR-82 obex: "
				+ (isClass("javax.obex.HeaderSet") ? "yes" : "no"));
		// The following should've been reported above in Profiles
		addLine(frmDetails, "JSR-118 MIDP2: "
				+ (isClass("javax.microedition.io.HttpsConnection") ? "yes"
						: "no"));
		addLine(frmDetails, "JSR-120 messaging: "
				+ (isClass("javax.wireless.messaging.Message") ? "yes" : "no"));
		addLine(frmDetails, "JSR-135 multimedia: "
				+ (isClass("javax.microedition.media.Manager") ? "yes" : "no"));
		addLine(frmDetails, "JSR-135 video: "
				+ (isClass("javax.microedition.media.TimeBase") ? "yes" : "no"));
		addLine(frmDetails, "JSR-172 web services: "
				+ (isClass("javax.xml.parsers.SAXParser") ? "yes" : "no"));
		addLine(frmDetails, "JSR-177 security services: "
				+ (isClass("java.security.Signature") ? "yes" : "no"));
		addLine(frmDetails, "JSR-179 location: "
				+ (isClass("javax.microedition.location.Location") ? "yes"
						: "no"));
		addLine(frmDetails, "JSR-180 SIP: "
				+ (isClass("javax.microedition.sip.SipConnection") ? "yes"
						: "no"));
		addLine(frmDetails, "JSR-184 3D graphics: "
				+ (isClass("javax.microedition.m3g.Node") ? "yes" : "no"));
		addLine(
				frmDetails,
				"JSR-185 JTWI: "
						+ (null == System
								.getProperty("microedition.jtwi.version") ? "no"
								: "yes (ver. "
										+ System
