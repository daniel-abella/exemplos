...
form = new Form ("form", new Item[] { getMensagem () });//GEN-BEGIN:|13-getter|1|13-postInit
...
if (okCommand == null) {//GEN-END:|18-getter|0|18-preInit
 // write pre-init user code here
okCommand = new Command ("getSizeAvailable", Command.OK, 0);//GEN-LINE:|18-getter|1|18-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: mensagem ">//GEN-BEGIN:|20-getter|0|20-preInit
/**
 * Returns an initiliazed instance of mensagem component.
 * @return the initialized component instance
 */
public StringItem getMensagem () {
if (mensagem == null) {//GEN-END:|20-getter|0|20-preInit
 // write pre-init user code here
    
mensagem = new StringItem ("Bytes dispon\u00EDveis:", null);//GEN-LINE:|20-getter|1|20-postInit
 // write post-init user code here
String valor = Servicos.rms1();
