...
/**
 * Oferece vários serviços para manipulação do formato CSV. Informações
 * sobre este formato podem ser obtidas em http://pt.wikipedia.org/wiki/Comma-separated_values. Por padrão, uma
