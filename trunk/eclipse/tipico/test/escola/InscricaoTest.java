...
/**
 * TODO Acrescentar código suficiente para ler descrições de curso e período de
 * inscrição correspondente a partir de arquivo, conforme documentado em
 * base-testes.txt (diretório dados).
 */
