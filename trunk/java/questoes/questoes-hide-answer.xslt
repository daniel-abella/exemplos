            ...
            <body title="Base de Questões (E-valuation)">
                <p>
                    <xsl:for-each select="Avaliacao">
                        <xsl:for-each select="identificacao">
                            <xsl:for-each select="titulo">
                                <span style="color:black; font-family:Verdana; font-size:18; font-weight:bold; ">
                                    <xsl:apply-templates />
                                </span>
                            </xsl:for-each>
                            <br />
                            <xsl:for-each select="versao">
                            	<span style="color:red; font-family:Verdana; font-size:14; font-weight:bold; ">
									Versão <xsl:apply-templates />
								</span>
                            </xsl:for-each>
                            <br />
                            <xsl:for-each select="copyright">
                                <span style="color:black; font-family:Arial; font-size:12; font-style:italic; ">Copyright (c) </span>
                                <span style="color:black; font-family:Arial; font-size:12; font-style:italic; ">2004</span>
                            ...
                            <br />
                            <span style="font-family:Arial; font-size:12; "><a href="mailto:fabio@inf.ufg.br">fabio@inf.ufg.br</a></span>
                            <br />
                    ...
                    <xsl:for-each select="Avaliacao">
                        <br />
                        <br />
                        <span style="color:black; font-family:Verdana; font-weight:bold; ">As respostas são obtidos ao clicar sobre o link RESPOSTA. Esperamos uma versão melhorada em breve, seja paciente.</span>
                        <br />
                        <br />
									   ...
									   <xsl:variable name="my_id"><xsl:value-of select="generate-id()"/>
										  ...
										  <td width="22">
											<span style="font-family:Arial; font-size:10; ">
												<a><xsl:attribute name="href">javascript:showhide('<xsl:value-of select="$my_id"/>');</xsl:attribute>
												RESPOSTA</a>
											</span>
                                          </td>
                                          <td colspan="6">
